...
var _medicinesRoutes = require("./api/medicine/medicines-routes");

var _medicinesRoutes2 = _interopRequireDefault(_medicinesRoutes);
...
function registerRoutes(app) {
    app.use("/api", _medicinesRoutes2.default);
